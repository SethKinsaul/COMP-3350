; HW8num2a.asm - Created by Seth Kinsaul
; Description: Accepts user input between -2,147,483,648 and +2,147,483,647 and performs binary multiplication between that number and 28 before writing the result to the screen.
