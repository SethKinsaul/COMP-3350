; HW10_4.asm - Created by Seth Kinsaul
; This program searches for the first occurance of a sequence of two characters in a string.
...
.data
welcomeMsg BYTE "Hello! This program searches for the first occurance of a sequence of two characters in a string.", 0
